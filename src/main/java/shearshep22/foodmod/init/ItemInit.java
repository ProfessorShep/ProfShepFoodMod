...
public class ItemInit {
	...
	public static final RegistryObject<Item> WAFFLE_CONE = ITEMS.register("waffle_cone",
			() -> new Item(new Item.Properties().group(ShepFood.shepfoodTab.instance)));
	...
	public static final RegistryObject<Item> WAFFLE_HONEY = ITEMS.register("waffle_honey",
	...
	public static final RegistryObject<Item> MUFFIN = ITEMS.register("muffin",
			() -> new Item(new Item.Properties().group(ShepFood.shepfoodTab.instance).food(new Food.Builder().hunger(4).saturation(2f).build())));
	...
	public static final RegistryObject<Item> ICE_CREAM_CONE = ITEMS.register("ice_cream_cone",
			() -> new Item(new Item.Properties().group(ShepFood.shepfoodTab.instance).food(new Food.Builder().hunger(3).fastToEat().saturation(2f).build())));
	...
	public static final RegistryObject<Item> ICE_CREAM_BOWL = ITEMS.register("ice_cream_bowl",
			() -> new SoupItem(new Item.Properties().group(ShepFood.shepfoodTab.instance).maxStackSize(1).food(new Food.Builder().hunger(4).saturation(3f).build())));
	...
	public static final RegistryObject<Item> MACARONI_AND_CHEESE = ITEMS.register("macaroni_and_cheese",
			() -> new SoupItem(new Item.Properties().group(ShepFood.shepfoodTab.instance).maxStackSize(1).food(new Food.Builder().hunger(7).saturation(3f).build())));
}